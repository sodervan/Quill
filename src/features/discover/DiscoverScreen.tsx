...
const s = StyleSheet.create({
  ...
  filterRow: { paddingHorizontal: space.md, paddingBottom: space.sm, gap: 8 },
  filterChip: {
    flexDirection: 'row', alignItems: 'center', gap: 6,
  ...
  resultCount: { ...T.caption, color: colors.textMuted, paddingHorizontal: space.lg, paddingBottom: space.sm },
